...
export default function NFTArtistPlatform() {
  ...
  // Simulate IPFS upload and contract deployment
  const deployNFT = async () => {
    ...
    try {
      ...
      const ipfsHash = 'Qm' + Array(44).fill(0).map(() => 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'[Math.floor(Math.random() * 58)]).join('');
